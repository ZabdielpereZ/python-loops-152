# range(stop) : creates a sequece of numbers that we can iterate through
...
# range(start, stoop) : creates a sequence of numbers from start (inclusive) to stop (non- inclusive)
...
for num in range(5, 11): # Creating a list on nums between 5-10 with a for loop 
    ...
    list_of_nums = list(range(5,11)) # Create a list on nums by type casting my range sequence into a list 
    print(list_of_nums)
    ...
    print("Range a range of numbers from 10 to 100, evry 10th digit")
    ...
    print("Printing only the odd numbers, from 20 to 0")
